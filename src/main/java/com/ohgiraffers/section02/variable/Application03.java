...
//        int int = 1;
        ...
        /* 목차. 1-4. 변수명은 숫자로 시작할수 없다. */
//        int 1age = 20;
        int age1 = 20;

        /* 목차. 1-5. 특수기호 '-' 와 '$'만 사용이 가능하다. */
        int _age = 20;
        int harp$ = 20;
//        int @asd = 20;
        ...
        int asfaldfkldsakflaklgladskglsa; // 에러는 나지 않는다
        ...
        /* 목차. 2-4. 한글로 변수명을 짓는 것이 가능하지만, 권장하지 않음 */
        int 나이;

        /* 목차. 2-5. 변수 안에 저장된 값이 어떤 의미로 가지는 지 명확하게 표현하도록 한다. */
        String s; // no
        String name; // 이렇게 한다
